module dtips.entrycache;

import std;
import dtips.database;
...
unittest
{
    ...
    cache.addEntry(Entry("a", "String to float", ["string", "conversion", "float"]));
    cache.addEntry(Entry("b", "String to int", ["string", "conversion", "int"]));
    cache.addEntry(Entry("c", "Float decimal part", ["float", "math"]));
    cache.addEntry(Entry("d", "Cross sum", ["math"]));
